        ...
        <Row>
          <Col className={`mb-4`}>
            <Card className={`p-2 ${style["description-card"]}`}>
              <Card.Body>
                <h5 data-testid="testH5" className={`mb-4`}>
                  Deskripsi
                </h5>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Necessitatibus at, magni velit id a omnis excepturi sit ipsam,
                  vel repellendus numquam? Ducimus consequuntur dolorum numquam
                  molestias quia, provident nemo? Voluptatum? Lorem ipsum dolor,
                  sit amet consectetur adipisicing elit. Voluptate, quibusdam
                  aspernatur totam voluptates quas nisi sequi dolorum, neque
                  architecto sed, saepe quae! Atque, itaque? Sit id possimus
                  reprehenderit labore iste.
                </p>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Necessitatibus at, magni velit id a omnis excepturi sit ipsam,
                  vel repellendus numquam? Ducimus consequuntur dolorum numquam
                  molestias quia, provident nemo? Voluptatum?
                </p>
              </Card.Body>
            </Card>
          </Col>
          <Col xl="4" lg="4" md="5" sm="12" xs="12">
            <Card className={`p-2 ${style["detail-product-card"]}`}>
              <Card.Body>
                ...
                >
                  {status ? "Terbitakan" : "Nego Sekarang"}
                </button>
                {status ? (
                  <button className={`mt-2 ${style["btn-decision"]}`}>
                    Edit
                  </button>
                ) : null}
              </Card.Body>
